...
var countdown = (time)=>{
    ...
    document.getElementById("hours").innerText = h > 10?h:'0'+h.toString();
    document.getElementById("minutes").innerText = m > 10?m:'0'+m.toString() ;
    document.getElementById("seconds").innerText = s > 10?s:'0'+s.toString();
